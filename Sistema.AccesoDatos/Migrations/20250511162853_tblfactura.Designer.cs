...
namespace SamsungV1.Data.Migrations
{
    ...
    [Migration("20250511162853_tblfactura")]
    partial class tblfactura
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sistema.Models.DetalleVenta", b =>
                {
            ...
            modelBuilder.Entity("Sistema.Models.Factura", b =>
                {
            ...
            modelBuilder.Entity("Sistema.Models.HistorialPrecios", b =>
                {
                    ...
                    b.Property<string>("Fecha_Cambio")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<decimal>("Precio_Anterior")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("Precio_Nuevo")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Sistema.Models.MetodosPago", b =>
                {
                    b.Property<int>("Id_metodoPago")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id_metodoPago"));
            ...
            modelBuilder.Entity("Sistema.Models.Venta", b =>
                {
                    b.Property<int>("Id_venta")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Sistema.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Sistema.Models.DetalleVenta", b =>
                {
                    ...
                    b.HasOne("Sistema.Models.Venta", "Venta")
                        .WithMany()
            ...
            modelBuilder.Entity("Sistema.Models.Factura", b =>
                {
                    ...
                    b.HasOne("Sistema.Models.Venta", "Venta")
                        .WithOne()
                        .HasForeignKey("Sistema.Models.Factura", "Id_venta")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Sistema.Models.Venta", b =>
                {
                    ...
                    b.HasOne("Sistema.Models.MetodosPago", "MetodoPago")
                        .WithMany()
