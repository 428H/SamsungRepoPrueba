                ...
                "render": function (data) {
                    return `<div class="dropdown text-center">
                              ...
                              <ul class="dropdown-menu" aria-labelledby="dropdownActions${data}">
                                <li>
                                  <a class="dropdown-item" href="/Almacen/Categorias/Edit/${data}">
                                    <i class="far fa-edit text-primary"></i> Editar
                                  </a>
                                </li>
                                <li>
                                  <a class="dropdown-item" href="#" onclick="Delete('/Almacen/Categorias/Delete/${data}'); return false;">
